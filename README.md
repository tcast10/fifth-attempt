...
This app powers todoster located [https://todoster-teddy-castro.herokuapp.com/] (Heroku Project URL)
...
## Test
```
cd /vagrant/src/todoster
rails s -b 0.0.0.0 -p 3000
```

## Clone this repository
```
git clone git@github.com:clarkngo/todoster.git
```
